 ...
 *
 */
public class MoveletsMultithread2 {
	...
	public MoveletsMultithread2(List<ITrajectory> trainForMovelets, List<ITrajectory> train, List<ITrajectory> test,
	...
	public List<ISubtrajectory> moveletsDiscovery(List<ITrajectory> trajectories, boolean filterAndRank){
		...
		for (ITrajectory trajectory : trajectories) {
			...
			MoveletsDiscovery2 shapeletsExtractor = new MoveletsDiscovery2(candidates, trajectory, trajectories, dmbt, (filterAndRank) ? qualityMeasure : null, minSize, maxSize, cache, exploreDimensions, nthreads);
	...
	public void run() {
		...
		List<ISubtrajectory> movelets = moveletsDiscovery(trainForMovelets, removeSelfsimilarAndRank);
